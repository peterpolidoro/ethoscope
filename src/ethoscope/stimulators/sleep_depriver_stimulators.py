...
class JaneliaOptoMotorAdaptiveSleepDepStimulator(IsMovingStimulatorDouble):
    _description = {"overview": "An adaptive stimulator to sleep deprive an animal using stepper motors.",
                    "arguments": [
                        ...
                        {"type": "number", "min": 10, "max": 720, "step": 1, "name": "min_motor_speed",
                         "description": "The motor speed in degree/sec", "default": 180},
                        {"type": "number", "min": 10, "max": 720, "step": 1, "name": "delta_motor_speed",
                         "description": "The increase/decrease in motor speed", "default": 90},
                        {"type": "number", "min": 100, "max": 10000, "step": 1, "name": "min_motor_acceleration",
                         "description": "The minimal motor acceleration", "default": 100},
                        {"type": "number", "min": 100, "max": 10000, "step": 1, "name": "max_motor_acceleration",
                         "description": "The maximal motor acceleration", "default": 10000},
                        {"type": "number", "min": 10, "max": 10000, "step": 1, "name": "delta_motor_acceleration",
                         "description": "The increase/decrease in motor acceleration", "default": 10},
                        {"type": "number", "min": 10, "max": 10000, "step": 1, "name": "motor_deceleration",
                         "description": "The motor deceleration", "default": 10000},
                        {"type": "number", "min": 60, "max": 5 * 60, "step": 1, "name": "low_time_threshold",
                         "description": "The minimal time threshold to increase the speed if fly falls asleep again quickly",
                         "default": 120},
                        {"type": "number", "min": 60, "max": 30 * 60, "step": 1, "name": "high_time_threshold",
                         "description": "The maximal time threshold to decrease the speed if fly does not fall asleep quickly",
                         "default": 60 * 30},
                        {"type": "date_range", "name": "date_range",
                         "description": "A date and time range in which the device will perform (see http://tinyurl.com/jv7k826)",
                         "default": ""},
                        {"type": "date_range2", "name": "date_range2",
